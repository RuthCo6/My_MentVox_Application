...
import { BaseChartDirective, NgChartsModule } from 'ng2-charts/lib/base-chart.directive';
...
export class UserStatisticsComponent implements OnInit {
  ...
  public systemBarChartData: ChartData<'bar'> = {
    ...
    datasets: [
      { label: 'Users', data: [], backgroundColor: 'rgba(255, 44, 118, 0.7)' },
      { label: 'Albums', data: [], backgroundColor: 'rgba(255, 206, 86, 0.7)' },
      { label: 'Files', data: [], backgroundColor: 'rgba(75, 192, 192, 0.7)' }
    ]
  };
